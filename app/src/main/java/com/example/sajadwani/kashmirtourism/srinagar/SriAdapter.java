...
public class SriAdapter extends PagerAdapter {
    private int[] img={R.drawable.shal, R.drawable.hari,R.drawable.badam,R.drawable.pat,R.drawable.mukh};
    private LayoutInflater inf;
    private Context ctx;

    public SriAdapter(Context ctx){
